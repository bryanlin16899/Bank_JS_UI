...
const btnResetTimer = document.querySelector('.reset_timer_btn');
...
//Income and outcome and interest
...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    // In each, print ther remaining time to UI
  ...
  // When another user log in, timer will reset.
  return timer;
};
